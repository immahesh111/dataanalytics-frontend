...
const List12 = () => {
    ...
    const fetchLeaves = async () => {
        try {
            const response = await axios.get(`https://dataanalytics-api.onrender.com/api/leave11/${id}/${user.role}`, {
                headers: {
    ...
    return (
        <div className='p-6'>
            ...
            <div className='flex justify-between items-center'>
                ...
                {user.role === "employee" && 
                    <Link to="/employee-dashboard/add-leave12" className='px-4 py-1 bg-custom-purple rounded text-white'>Fill New CheckSheet</Link>}
            </div>
